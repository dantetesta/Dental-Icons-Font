...
1. Abra `DentalIconsUpper-Regular.otf` e `DentalIconsLower-Regular.otf` no Catálogo de Fontes.
...
Instale os arquivos TTF no sistema operacional, reinicie o aplicativo e selecione a família correspondente à arcada. O suporte a ligaturas OpenType pode variar conforme a versão e o mecanismo de layout de texto.

## Uso como webfont

Copie os WOFF2 e `dental-icons.css` para o mesmo diretório:
