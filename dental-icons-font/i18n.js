(() => {
  ...
  const ENTRIES = [
    ...
    ["Instale no Windows ou Linux e procure por Dental Icons Up ou Dental Icons Down.", "Install on Windows or Linux and look for Dental Icons Up or Dental Icons Down.", "Instala en Windows o Linux y busca Dental Icons Up o Dental Icons Down.", "Instale no Windows ou Linux e procure Dental Icons Up ou Dental Icons Down."],
    ...
    ["usando exatamente os mesmos nomes das fontes desktop.", "using exactly the same names as the desktop fonts.", "usando exactamente los mismos nombres de las fuentes de escritorio.", "utilizando exatamente os mesmos nomes dos tipos de letra para desktop."],
    ...
    ["Nome na web", "Web name", "Nombre en la web", "Nome na web"],
    ["Um padrão em todo lugar:", "One standard everywhere:", "Un estándar en todas partes:", "Um padrão em todo o lado:"],
    ["Up = arcada superior e Down = arcada inferior. Use Dental Icons Up e Dental Icons Down no desktop, no CSS e nos sistemas web.", "Up = upper arch and Down = lower arch. Use Dental Icons Up and Dental Icons Down on desktop, in CSS and in web systems.", "Up = arcada superior y Down = arcada inferior. Usa Dental Icons Up y Dental Icons Down en escritorio, CSS y sistemas web.", "Up = arcada superior e Down = arcada inferior. Utilize Dental Icons Up e Dental Icons Down no desktop, no CSS e nos sistemas web."],
    ...
    ["Selecione Dental Icons Up (superior) ou Dental Icons Down (inferior).", "Select Dental Icons Up (upper) or Dental Icons Down (lower).", "Selecciona Dental Icons Up (superior) o Dental Icons Down (inferior).", "Selecione Dental Icons Up (superior) ou Dental Icons Down (inferior)."],
    ...
    ["Use Dental Icons Up (superior) ou Dental Icons Down (inferior), com ligaturas ativas.", "Use Dental Icons Up (upper) or Dental Icons Down (lower), with ligatures enabled.", "Usa Dental Icons Up (superior) o Dental Icons Down (inferior), con las ligaduras activadas.", "Utilize Dental Icons Up (superior) ou Dental Icons Down (inferior), com as ligaturas ativas."],
    ...
    ["Procure por Dental Icons Up (superior) ou Dental Icons Down (inferior).", "Look for Dental Icons Up (upper) or Dental Icons Down (lower).", "Busca Dental Icons Up (superior) o Dental Icons Down (inferior).", "Procure Dental Icons Up (superior) ou Dental Icons Down (inferior)."],
    ...
    ["Dental Icons Up — superior", "Dental Icons Up — upper", "Dental Icons Up — superior", "Dental Icons Up — superior"],
    ["Dental Icons Down — inferior", "Dental Icons Down — lower", "Dental Icons Down — inferior", "Dental Icons Down — inferior"],
